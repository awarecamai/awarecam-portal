...
const accountSteps: Step[] = [
  ...
  },
  {
    ...
    details: [
      "The left sidebar contains: Dashboard, Cameras, Live View, Alerts, Analytics, Locations, Workflows, and Settings.",
  ...
  {
    number: 14,
    title: "Configure Workflows & Schedules",
    description: "Workflows let you automate alert rules — for example, only alert after business hours, or escalate to a second contact if the first doesn't respond.",
    details: [
      "Click 'Workflows' in the left sidebar.",
      "Click 'New Workflow'.",
      "Name the workflow (e.g., 'After Hours Alert Escalation').",
      "Set the trigger: select an AI agent (e.g., Person Detection) and a camera or zone.",
      "Set the schedule: choose Active Hours (e.g., Mon–Fri 6pm–8am, all day on weekends).",
      "Set the action: Send Email, Send SMS, or Webhook.",
      "Add escalation: if no response in X minutes, send to a second contact.",
      "Click 'Save Workflow'.",
    ],
    screenshot: "AwareCam Workflows page — workflow builder with trigger section (agent selector, camera selector), schedule section (day/time picker), and action section (email/SMS/webhook toggles). 'Save Workflow' button at bottom.",
    screenshotAlt: "AwareCam workflow builder — automated alert rules",
    tip: "The most common workflow is 'After Hours Person Detection' — alert security staff only when people are detected outside of business hours. This eliminates daytime false alarms completely.",
  },
  {
    number: 15,
    title: "Download the Mobile App",
    description: "Install the AwareCam mobile app to receive real-time push notifications and view live cameras from anywhere.",
    details: [
      "iOS: Search 'AwareCam' on the Apple App Store, or visit awarecam.com/app.",
      "Android: Search 'AwareCam' on the Google Play Store, or visit awarecam.com/app.",
      "Log in with the same email and password used on the web platform.",
      "Allow push notifications when prompted — this is required to receive AI alerts.",
      "The app shows: live camera feeds, alerts inbox, analytics summary, and site status.",
      "Multiple users can be added to the same organization — each receives their own alerts.",
    ],
    screenshot: "AwareCam mobile app — home screen showing site status card, recent alerts list with thumbnails, and bottom navigation bar with icons for Home, Live, Alerts, and Settings.",
    screenshotAlt: "AwareCam mobile app home screen",
    tip: "Share the app download link with your client's security team and management. Multiple users can receive alerts simultaneously from the same site.",
  },
];
...
const kioskSteps: Step[] = [
  {
    ...
    screenshot: "AwareCam Kiosk kit contents laid out on a table — Raspberry Pi 4 board, USB-C power supply, Ethernet cable, HDMI cable, and a small printed quick-start card.",
    screenshotAlt: "AwareCam Kiosk hardware kit contents",
  ...
  },
  {
    ...
    screenshot: "Raspberry Pi 4 with Ethernet cable plugged into the left port and HDMI cable plugged into the HDMI0 port (closest to USB-C power). Power cable not yet connected.",
    screenshotAlt: "Raspberry Pi cable connections — Ethernet and HDMI connected, power not yet connected",
  ...
  },
  {
    ...
    screenshot: "AwareCam app — Gateway Devices settings page showing a modal with a large provisioning code 'XKMT-72PQ3' displayed in a bold font, with a copy button and a 24-hour expiry notice.",
    screenshotAlt: "AwareCam app — provisioning code generation modal",
  ...
  },
  {
    ...
    screenshot: "AwareCam Kiosk cameras page — list of discovered cameras with IP addresses and brand icons. One camera shows 'Configure' button highlighted. Below it, a configuration panel with name, brand, username/password fields, and RTSP URL dropdown.",
  ...
  },
  {
    ...
    details: [
      ...
      "Confirm the alert appears in the mobile app and the Alerts page.",
    ],
    screenshot: "AwareCam app Cameras page — list of cameras synced from the Kiosk, each showing camera name, location, status badge ('Online' in green), and AI agents count. 'Configure Agents' button on each row.",
...
const windowsSteps: Step[] = [
  ...
  },
  {
    ...
    screenshot: "Windows Services window — 'AwareCam Edge Agent' service highlighted, Status: Running, Startup Type: Automatic. Right-click context menu showing Properties option.",
...
const troubleshootingItems = [
  ...
  { q: "No alerts being received", a: "Verify AI agents are enabled in app.awarecam.com. Check notification permissions in the mobile app. Walk in front of a camera to trigger a test alert." },
...
const guides = [
  {
    ...
    steps: accountSteps,
    description: "Complete walkthrough: account creation, onboarding, adding cameras, drawing zones, AI agents, alerts, analytics, and mobile app.",
  },
  {
            ...
            <div className="p-4 rounded-xl border border-border bg-card">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { icon: Smartphone, label: "Mobile App", desc: "iOS & Android alerts" },
                ].map((f) => (
