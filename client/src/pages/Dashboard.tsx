        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {visibleLinks.map((link) => {
              ...
              return (
                <Link key={link.href} href={link.href} className={`group block p-5 rounded-xl border ${link.border} bg-gradient-to-br ${link.color} hover:border-primary/40 transition-all cursor-pointer`}>
        ...
        {portalRole === "admin" && (
          <div className="mt-6 p-5 rounded-xl border border-orange-500/20 bg-gradient-to-br from-orange-500/10 to-orange-600/5">
            <div className="flex items-center justify-between">
              ...
              <Link href="/admin" className="flex items-center gap-2 text-xs text-orange-400 hover:text-orange-300 font-medium transition-colors">
